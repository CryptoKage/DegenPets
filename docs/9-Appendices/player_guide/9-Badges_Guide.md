...
There are two main categories of Badges:
...
*   **Full List:** Refer to the [Appendix: Badge List](../Badge_List.md) for a comprehensive list of currently available Player and Pet badges, their trigger conditions, and placeholder $DGPT rewards.
*   **In-Game (Player):** Check your Player Profile section within the application to see which Player Badges you have already earned.
*   **In-Game (Pet):** Navigate to a specific Pet's Detail View to see the Pet Badges it has earned throughout its trading history.
...
*   Experiment with different market assignments to earn "Market Explorer".
*   Use items regularly to work towards "Item Enthusiast".
*   Participate in every tournament type, even if you don't expect to win, to collect participation badges and work towards potential "Champ" badges.

The Badge system ensures that nearly all forms of engagement with the Degen Pets ecosystem are recognized and potentially rewarded.

---

**Next Step:** Understand the core token in [Guide: $DGPT Economy Basics](10-DGPT_Basics.md).
