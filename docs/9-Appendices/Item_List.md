...
Items in Degen Pets provide players with tools to manage their Pets' Mood or gain insights. Items are purchased using $DGPT from the in-game Shop and consumed upon use.

**Note:** All $DGPT cost values marked with * are initial placeholders and subject to final balancing based on economic modeling and testing. Burn rates for items are also TBD (currently assumed 0%* for recirculation). Effects may be tuned based on testing.

## Consumable Items

These items are consumed when used on a specific Pet.
...
| **Relaxants**     | Instantly increases selected Pet's Mood by **+50*** points.                      | 40* $DGPT    | 100%*        | Stronger mood recovery.                                               |
...
These items represent one-time purchases that unlock features for the player account.
