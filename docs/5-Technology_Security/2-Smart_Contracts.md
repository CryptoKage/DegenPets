...
* Dependencies: DGPToken, LPTokenLocker Proxy, DEX Router (IUniswapV2Router02 interface), WETH.
* Configuration (Testnet): Router (0x475...), WETH (0x42...06), Treasury (0x657C...), Locker (0x47Eb...), Slippage (0.5%). NOTE: Assumes target DEX uses Uniswap V2 interface.
